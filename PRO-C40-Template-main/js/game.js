    ...
    play() {
        ...
        for (var plr in allPlayers) {
            ...
            if (index === player.index) {
                ...
                text("Player 1 :" + allPlayers.player1.name, 100, 100);
                text("Player 2 :" + allPlayers.player2.name, 100, 135);

            }

            textSize(25);
            fill("white");
            text(allPlayers.player1.name, players[0].x-35, players[0].y+25);
            text(allPlayers.player2.name, players[1].x-35, players[1].y+25);
